...
<div class=" font-family container">
	...
	<div class="row">
		...
		<div class="col-md-6 col-xs-10 img-thumbnail1" style="margin: 0px;padding: 0px">
            <div style="width:100%;height:308px;border:#ccc solid 1px;" id="dituContent"></div>
            <script type="text/javascript">
                //创建和初始化地图函数：
                function initMap(){
                    createMap();//创建地图
                ...
                function createMap(){
                    ...
                    var point = new BMap.Point(116.732861,39.204238);//定义一个中心点坐标
...
//                    map.enableDoubleClickZoom();//启用鼠标双击放大，默认启用(可不写)
                ...
                //标注点数组
                var markerArr = [{title:"公司地址",content:"永清县里澜城镇",point:"116.732861|39.204238",isOpen:0,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}
                ];
                //创建marker
                function addMarker(){
                ...
                function createIcon(json){
                    var icon = new BMap.Icon("http://phping.cf/point.gif", new BMap.Size(json.w,json.h),{imageOffset: new BMap.Size(-json.l,-json.t),infoWindowOffset:new BMap.Size(json.lb+5,1),offset:new BMap.Size(json.x,json.h)})
                    return icon;
                }

                ...
                <div class="row-fluid">
                    <div class="span12">
                         <div  class="daohanglink"style="">
                           ...
                           <span>问题管理</span>
                           <a  href="<?php echo U('admin/question/add');?>" class="label label-warning" style="float:right; margin:8px;">添加</a>
                         </div>
                            ...
                            <div class="well-content" style="border:0px;">
                                <table class="table table-striped table-bordered table-hover datatable">
                                    ...
                                    <?php if(is_array($question)): $i = 0; $__LIST__ = $question;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>
                                            <a class="btn" href="/admin/question/manage/id/<?php echo ($vo["questionid"]); ?>" title="修改">修改</a>
                                            <a class="btn" href="/admin/question/del/id/<?php echo ($vo["questionid"]); ?>" title="删除">删除</a>
                                            <a class="btn" href="/admin/question/show/id/<?php echo ($vo["questionid"]); ?>" title="查看">查看</a>
                                            </td>

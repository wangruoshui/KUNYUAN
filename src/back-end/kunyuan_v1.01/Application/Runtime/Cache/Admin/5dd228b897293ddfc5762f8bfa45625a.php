...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="/admin/log/dologin" method="post">
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img src="/admin/log/captcha"  width="30%" onclick="this.src=this.src+'?'"/> <a id="kanbuq" href="#">点击图片换一换</a> </div>
      </div>

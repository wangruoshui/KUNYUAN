    ...
    <div  class="daohanglink">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list">
                <i class="icon-font"></i><a href="index.html">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="allCategorys.html">信息管理</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="allCategorys.html">修改内容</a>
            </div>
        </div>
    </div>
    <div class="well">
        <form action="<?php echo U('admin/common/modify');?>" method="post" enctype= "multipart/form-data">
            <table class="insert-tab" width="100%">
                ...
                <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <tr>
                        <th>标题：</th>
                        <td><input class="title" name="title" size="50" type="text" value="<?php echo ($data["title"]); ?>"></td>
                    </tr>
                    <tr>
                        <th>内容：</th>
                        <td>
                            <textarea class="content" name="content" cols="30" style="width: 60%;" rows="5"><?php echo ($data["content"]); ?></textarea>
                        </td>
                    </tr>
                    <tr>
